...
/**
 * 一段定稿的 assistant 输出。**这是唯一进历史的事件形状**——流式片段不进，
 * 所以每段文字/工具结果最终都必须以 assistantMessage 收尾，否则刷新后就没了。
 */
 ...
 * 刻意不进历史：真正的结果已经在 assistantMessage 的 tool_result 块里了，
